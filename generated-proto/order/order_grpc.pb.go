...
type OrderManagementClient interface {
	// unary
	GetOrder(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Order, error)
}
...
func (c *orderManagementClient) GetOrder(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
type OrderManagementServer interface {
	// unary
	GetOrder(context.Context, *ProductId) (*Order, error)
...
func (UnimplementedOrderManagementServer) GetOrder(context.Context, *ProductId) (*Order, error) {
...
func _OrderManagement_GetOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderManagementServer).GetOrder(ctx, req.(*ProductId))
	}
